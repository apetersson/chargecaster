...
from price_forecast_lib import train_and_evaluate


def main() -> None:
    parser = argparse.ArgumentParser(description="Train the Chargecaster price forecast model.")
    ...
    summary = {
        ...
        "heuristic_mae": result["metrics"]["heuristic"]["mae"],
